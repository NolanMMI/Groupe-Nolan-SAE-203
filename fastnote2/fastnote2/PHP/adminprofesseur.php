...
<head>
    ...
    <link rel="stylesheet" href="CSS/Adminprofesseur.css">
...
<div class="container">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <a class="modifier-link" href="modifier_professeur.php?id=<?= $candidat['id_prof'] ?>">Modifier</a>
                <a class="supprimer-link" href="supprimer_professeur.php?id=<?= $candidat['id_prof'] ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce candidat ?');">Supprimer</a>
            </td>
        </tr>
        <?php endforeach; ?>
    </table>
...
<div class="form-container" id="formulaireAjout" style="display: none;">
    <form id="prof-form" method="post">
        ...
        <div class="button-group">
            ...
            <button type="button" onclick="location.href='adminprofesseur.php';">Annuler</button>
        </div>
    </form>
</div>
<script>
