...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt->execute([ $_POST['nom_mod'], $_POST['id_prof'], $_POST['id_mod']]);
    ...
    <div class="starter-template">
        ...
        <form method="post" action="modifier_ressources.php">
            ...
            <div class="form-group">
                <label for="nom_mod">Nom de la ressource</label>
                <input type="text" class="form-control" id="nom_mod" name="nom_mod" value="<?= htmlspecialchars($candidat['nom_mod']) ?>" required>
            </div>
            <div class="form-group">
                <label for="id_prof">ID du professeur</label>
                <input type="text" class="form-control" id="id_prof" name="id_prof" value="<?= htmlspecialchars($candidat['id_prof']) ?>" required>
            </div>
